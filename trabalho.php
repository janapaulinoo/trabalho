...
<body>
    <div class="container">
        ...
        <form action="" method="post">
            ...
            <input type="number" id="meta_semanal" name="meta_semanal" value="20000" required><br>
            <label for="meta_mensal">Meta de Venda Mensal (em R$):</label><br>
            <input type="number" id="meta_mensal" name="meta_mensal" value="80000" required><br><br>
